...
- **Menu bar app:** [`Forge-macos-arm64.app.zip`](https://github.com/SimonAB/forge/releases/latest/download/Forge-macos-arm64.app.zip) — unzip and drag `Forge.app` into **Applications** (or use **Forge → Check for Updates…** once you already have a copy installed).
