...
PLUGIN_JS = r"""// Forge: open Apple Mail for the selected task without a browser flash.
...
def write_plugin() -> Path:
    ...
    manifest = {
        ...
        "description": (
            "Header button: open the selected task in Apple Mail by Message-Id "
            "(Mail message object; no message:// / no HTML; Node required)."
        ),
        "author": "Forge",
        "icon": "icon.svg",
        "permissions": [
